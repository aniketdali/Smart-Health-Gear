...
#include <disk/spi_flash.h> // Initialize Flash CS pin
#include <i2c2.hpp>          // I2C2 init
#include <i2c1.hpp>			// I2C1 init
...
void high_level_init(void)
{
    ...
    if (!I2C1::getInstance().init(SYS_CFG_I2C2_CLK_KHZ)) {					// for i2c1 j
        puts("ERROR: Possible short on SDA or SCL wire (I2C1)!");
    }
