...
class I2C2 : public I2C_Base, public SingletonTemplate<I2C2>
{
    public:
      ...
      //  void initSlave(slaveAddr, &buffer, sizeof(buffer));
...
enum Board_I2C_Device_Addresses{
	...
	I2CAddr_TemperatureSensorOnBoard  = 0x90, /* AD0 pin tied to Gnd */
    I2CAddr_LED_Display        = 0x40,
	I2CAddr_Board_Display      = 0xC0,
//	I2CAddr_HeartRateSensor = 0xAE,
};
